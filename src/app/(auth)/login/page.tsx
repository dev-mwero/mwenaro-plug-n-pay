...
export default function LoginPage() {
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      <div className="relative hidden lg:flex flex-col justify-between p-12 bg-emerald-950 text-white overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <div className="absolute -top-24 -left-24 w-96 h-96 bg-emerald-500 rounded-full blur-[100px]" />
          <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-emerald-400 rounded-full blur-[100px]" />
        </div>
        ...
        <div className="relative z-10 space-y-6">
          <blockquote className="space-y-4">
            ...
            <footer className="text-sm">
              ...
              <span className="block text-emerald-300/80">CTO at TechTuku</span>
            </footer>
          </blockquote>
        </div>
      ...
      <div className="flex items-center justify-center p-8 bg-gray-50">
        <div className="w-full max-w-sm">
          <div className="lg:hidden mb-12 flex justify-center">
             <h1 className="text-2xl font-bold text-emerald-800">Mwenaro PlugPay</h1>
          </div>
          <LoginForm />
        </div>
      </div>
